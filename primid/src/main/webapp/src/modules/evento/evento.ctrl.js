...
(function (ng) {
    ...
    mod.controller("eventoCtrl", ["$scope", "eventoService", function ($scope, svc) {
            ...
            $scope.currentRecord = {
                ...
                endDate: '' /*Tipo Date*/,
                ciudad: '' /*Tipo Ciudad*/,
                comments: [{/*ColecciÛn de registros de Review*/
                        ...
                        name: '' /*Tipo String*/,
                        description: '' /*Tipo String*/
                    }] /*ColecciÛn de registros de Review*/
            };
            $scope.records = [];
             ...
             * sentencia &broadcast ("nombre del evento", record), esto con el fin cargar la informaci√≥n de modulos hijos
             * al actual modulo.
             ...
             * Muestra el template de la lista de records al finalizar la operaci√≥n saveRecord
             */
